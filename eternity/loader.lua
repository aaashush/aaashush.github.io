...
function Lib:Create(options)
	...
	Lib["4"]["BackgroundColor3"] = Color3.fromRGB(14, 14, 14);
	...
	function options:creategame(opt)
		if not opt then
			opt = {
				name  = "fallen";
				image = "rbxassetid://94000877216738";
                status= "ud";
				call  = function(...) end;
			};
		end;
