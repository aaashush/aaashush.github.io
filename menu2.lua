...
local library = {
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'eternity.wtf';
...
function library:init()
    ...
    do
        ...
        self.watermark = {
            ...
            text = {
                {self.cheatname, true},
                {("%s"):format(eternity_User.User), true},
                {self.gamename, true},
                {'0 fps', true},
                {'0ms', true},
                {'00:00:00', true},
